...
// virtual
void VART::SceneNode::TraverseDepthFirst(SNOperator* operatorPtr)
{
...
// virtual
void VART::SceneNode::TraverseBreadthFirst(SNOperator* operatorPtr)
{
    list<SceneNode*> queue;
    SceneNode* nodePtr;
...
// virtual
void VART::SceneNode::LocateDepthFirst(SNLocator* locatorPtr)
{
...
// virtual
void VART::SceneNode::LocateBreadthFirst(SNLocator* locatorPtr)
{
    list<SceneNode*> queue;
    SceneNode* nodePtr;
    queue.push_back(this);
