...
/// should be considered abstract.
    class SceneNode : public MemoryObj {
        ...
        // PUBLIC METHODS
            ...
            virtual void TraverseBreadthFirst(SNOperator* operatorPtr);
            ...
            /// node.
            virtual void LocateDepthFirst(SNLocator* locatorPtr);
            ...
            virtual void LocateBreadthFirst(SNLocator* locatorPtr);
